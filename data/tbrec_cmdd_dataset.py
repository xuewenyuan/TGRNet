...
class TbRecCMDDDataset(BaseDataset):

    @staticmethod
    def modify_commandline_options(parser, is_train=True):
        parser.add_argument('--alpha', type=float, default=3, help='the adjustment factor alpha')
        parser.add_argument('--num_cols', type=int, default=6, help='the number of columns for classification')
        parser.add_argument('--num_rows', type=int, default=25, help='the number of rows for classification')
        return parser
